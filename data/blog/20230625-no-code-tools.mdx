...
<img src="/static/images/nocode-block.png" alt="syctree UI" />

dictionary를 통해서 환경마다 원하는 값들 저장하고, Dictionary이라는 Block을 통해서 가져 올 수 있다.

<img src="/static/images/nocode-dictionary1.png" alt="syctree UI - dictionary setting" />

<img src="/static/images/nocode-dictionary2.png" alt="syctree UI" - dictionary block/>

gitflow의 환경들이 있다. 그런데 production에서만 public하게 API가 공개된다. Stage의 환경에 있는 API에도 외부에서 별도로 접근하여 production에 배포하기 전에 확인하고 싶은데, 싱크트리에서 제공하는 public API는 production 기준으로만 접근이 가능하다.

<img src="/static/images/nocode-environment.png" alt="syctree UI" - Environment/>
