...
date: '2023-08-04'
tags: ['book']
summary: '<콜드 스타트> 책을 읽으면서 네트워크 상품이 어떻게 성장하고 어떠한 단계들을 거쳐나가게 될 수 있는지 생각해볼 수 있었다. 새로운 네트워크 상품은 네트워크를 처음부터 구축해야 되는 콜드 스타트 문제를 가진다. 작지만 밀도가 높은 원자적 네트워크를 구성하여 초기 콜드 스타트 문제를 해결해야 하고, 이것은 초기 생존과 연관된다. 원자적 네트워크를 바탕으로 확장하고 성장하면 네트워크 효과가 경쟁자가 동일한 기능을 모방해서 도전한다고 해도 방어막 역할을 해줄 수 있다.'
---
